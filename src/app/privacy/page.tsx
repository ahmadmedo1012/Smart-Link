      ...
      <div className="container-base max-w-3xl mx-auto relative">
        ...
        >
          ...
          <section>
            ...
            <p className="mt-2">لأغراض تشغيلية بحتة، نعتمد على مزودي خدمات يعملون نيابة عنا وفق تعليماتنا: Resend لتوصيل رسائل البريد الإلكتروني، وVercel لاستضافة الموقع ومعالجة بيانات النموذج. لا يستخدم هذان المزودان بياناتك لأي غرض خاص بهما، ويُعالجانها فقط لتنفيذ الخدمة المطلوبة.</p>
          </section>
