  ...
  return (
    <footer className="border-t border-[var(--border)] bg-[var(--surface-sunken)] relative">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className="w-9 h-9 rounded-lg bg-[var(--accent)] flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-[var(--primary)] hover:text-white transition-all duration-300 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-[var(--ring)]"
                >
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-10 h-10 rounded-xl bg-[var(--primary)] text-white flex items-center justify-center shadow-lg hover:brightness-110 transition-all duration-300 z-40 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-[var(--ring)]"
      >
